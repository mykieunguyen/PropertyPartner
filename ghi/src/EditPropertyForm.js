...
function EditPropertyForm () {
    ...
    const { data: getImages, isLoading: imageLoading } = useGetImagesQuery(propertyId);
      ...
      return (
        ...
        <div className="offset-3 col-6">
            ...
            <form onSubmit={handleSubmit} id="create-property-form">
              ...
              <div>
                <input value={multistory} onChange={(e) => setMultistory(!multistory)} type="checkbox" name="multistory" id="multistory" checked={multistory}/>
                <label htmlFor="multistory">Multistory</label>
              </div>
              <div>
                <input value={new_build} onChange={(e) => setNewBuild(!new_build)} type="checkbox" name="new_build" id="new_build" checked={new_build}/>
